...
public class Cliente extends Pessoa{
    ...
    void Seguidos(Scanner scan, ArrayList<Livro> livros) // Visualiza a lista de items seguidos
    {
        int menu = 10;
        int tam;
        do{
            ...
            for (int i = 0; i < tam; i++)
    	    {
                ...
                livrosSeguidos.get(i).last = livrosSeguidos.get(i).qtd; // Atualiza o valor que estava previamente guardado, de forma a limpar a notificação
            }
            Visual.fimBorda(this);
